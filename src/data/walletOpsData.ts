...
export const INITIAL_USERS: WalletUser[] = [
  ...
  { id: 'kitchen_47',name: 'Cloud Kitchen #47', shortName: 'Kitchen 47', type: 'merchant', kycTier: 2, balance: 12450.00, monthlyVolume: 87000.00, monthlyLimit: 200000, joinedMonthsAgo: 18, avatarInitials: 'CK' },
  { id: 'qsr_olaya',  name: 'QSR Branch Olaya',  shortName: 'QSR Olaya',    type: 'merchant', kycTier: 2, balance: 24890.00, monthlyVolume: 134000.00, monthlyLimit: 200000, joinedMonthsAgo: 31, avatarInitials: 'QO' },
]
...
export const INITIAL_TRANSACTIONS: WalletTransaction[] = [
  ...
  h('TXN-2003-G7H8I9', minsAgo(6),  'payout_instant',     'kitchen_47','muhammad_i',320.00,  'completed', 2.72, [{ account: 'user:kitchen_47', debit: 320, credit: 0 }, { account: 'bank:rajhi_driver', debit: 0, credit: 320 }]),
  h('TXN-2004-J1K2L3', minsAgo(9),  'merchant_settlement','qsr_olaya',  'bank',       8400.00, 'completed', 16.80, [{ account: 'user:qsr_olaya', debit: 8400, credit: 0 }, { account: 'bank:anb_merchant', debit: 0, credit: 8400 }]),
  ...
  h('TXN-2008-V4W5X6', minsAgo(21), 'payout_standard',    'kitchen_47','hassan_a',  480.00,  'completed', 0.72, [{ account: 'user:kitchen_47', debit: 480, credit: 0 }, { account: 'bank:rajhi_driver', debit: 0, credit: 480 }]),
  ...
  h('TXN-2012-H7I8J9', minsAgo(35), 'merchant_settlement','kitchen_47','bank',       4050.00, 'completed', 8.10, [{ account: 'user:kitchen_47', debit: 4050, credit: 0 }, { account: 'bank:anb_merchant', debit: 0, credit: 4050 }]),
  h('TXN-2013-K1L2M3', minsAgo(38), 'payout_instant',     'qsr_olaya',  'yousef_m',  780.00,  'awaiting_approval', 6.63, [], 'Amount > SAR 500 threshold'),
  ...
  h('TXN-2019-C1D2E3', minsAgo(61), 'payout_standard',    'qsr_olaya',  'muhammad_i',560.00,  'completed', 0.84, [{ account: 'user:qsr_olaya', debit: 560, credit: 0 }, { account: 'bank:rajhi_driver', debit: 0, credit: 560 }]),
  ...
  h('TXN-2021-I7J8K9', minsAgo(70), 'merchant_settlement','kitchen_47','bank',       3800.00, 'completed', 7.60, [{ account: 'user:kitchen_47', debit: 3800, credit: 0 }, { account: 'bank:anb_merchant', debit: 0, credit: 3800 }]),
  ...
  h('TXN-2028-D1E2F3', minsAgo(99), 'payout_instant',     'qsr_olaya',  'hassan_a',  420.00,  'completed', 3.57, [{ account: 'user:qsr_olaya', debit: 420, credit: 0 }, { account: 'bank:rajhi_driver', debit: 0, credit: 420 }]),
  h('TXN-2029-G4H5I6', minsAgo(103),'merchant_settlement','qsr_olaya',  'bank',       5200.00, 'completed', 10.40, [{ account: 'user:qsr_olaya', debit: 5200, credit: 0 }, { account: 'bank:anb_merchant', debit: 0, credit: 5200 }]),
...
export const INITIAL_APPROVALS: PendingApproval[] = [
  {
    ...
    txType: 'payout_instant', fromUser: 'QSR Branch Olaya', toUser: 'Yousef Mohammed',
  ...
  },
  {
    ...
    txType: 'merchant_settlement', fromUser: 'Cloud Kitchen #47', toUser: 'Bank',
